...
export function DocumentIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="15" viewBox="0 0 50 50" fill="#14b8a6">
...
export function BookmarkIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="15" viewBox="0 0 24 24" fill="#14b8a6">
...
export function FilledLikeIcon({ fill, stroke }: { fill?: string; stroke?: string }) {
    return (
        <svg width="17px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
            <path
                fill={fill ? fill : '#14b8a6'}
                stroke={stroke ? stroke : '#14b8a6'}
                strokeLinecap="round"
