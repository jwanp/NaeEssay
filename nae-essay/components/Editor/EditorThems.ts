const editorTheme = {
    ...
    quote: 'border-l-4 border-gray-300 p-2 pl-4 text-gray-700 italic ',
    heading: {
    ...
    list: {
        ...
        ol: 'space-y-1 text-gray-500 list-decimal list-inside dark:text-white',
        ul: 'space-y-1 text-gray-500 list-disc list-inside dark:text-white',
        listitem: 'dark:text-white',
    },
    image: 'editor-image',
    link: 'font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer',
    text: {
        bold: 'font-bold',
        italic: 'italic',
