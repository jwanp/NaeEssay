        ...
        <>
            <div className="flex justify-between px-[40px] py-[20px]">
                <div className="flex items-center ">
                    ...
                    <h4 className="font-medium text-base ml-6 text-green-600">{qnaCount}개 게시물</h4>
                </div>

                <div className="flex items-center">
                    {/* https://tailwindui.com/components/application-ui/forms/select-menus */}
                    <QnADropDown />
                    <button className="hidden md:block w-[96px] px-3 bg-green-600 hover:bg-green-500 duration-300 rounded-2xl text-white ml-[40px] h-[48px]">
                        글쓰기
                    </button>
                </div>
            </div>
            <div className="px-4 md:hidden py-[20px]">
                <button className="w-full px-3 bg-green-600 hover:bg-green-500 duration-300 rounded-3xl text-white h-[48px]">
                    글쓰기
                </button>
            </div>
        </>
