...
import { changeQnaSort } from '@/lib/features/sort/SortSlice';
...
export default function QnADropDown() {
    const sort = useAppSelector((state) => state.qnaSort);
    ...
    return (
        <div className="mx-auto w-[120px] ">
            <Combobox
                ...
                onChange={(sortValue) => {
                    sortValue == null
                        ? dispatch(changeQnaSort(englishSorts[0]))
                        : dispatch(changeQnaSort(englishSorts[sortValue.id - 1]));
                }}>
